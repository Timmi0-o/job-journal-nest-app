import type { IPaginationMeta } from '@application/dtos/common/pagination.dto';
...
export interface IFindManyAndCountParams {
...
export class GetManyHelper {
  ...
  public static prepareQuery<TOrderBy, TSelect = string>(
    ...
    return {
      ...
      offset,
      orderBy,
      select: params.presetSelect as TSelect[] | undefined,
    };
  }
  ...
  public static buildResponse<TData>(
    ...
    if (!data.length) {
      this.logger.debug(params.emptyLogMessage);
    }
