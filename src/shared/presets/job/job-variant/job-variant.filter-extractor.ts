...
import type { IJobVariantFiltersPreset } from './job-variant-filters-preset.types';

export class JobVariantFilterExtractor {
  static extract(preset?: IJobVariantFiltersPreset): Record<string, unknown> {
    if (!preset) return {};
